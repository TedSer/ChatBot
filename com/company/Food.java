...
public class Food extends Bot {
    ...
    public void foodCommand(Update update) {
        ...
        if (update.getMessage().getText().equals("Франківський район")){
            foodParce.foodInFrank(update);

        }
        if(update.getMessage().getText().equals(("Личаківський район"))){
            foodParce.foodInLuchakiv(update);
        }
