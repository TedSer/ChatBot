...
public class ParsZankovecka extends Theatres {

    public void parce(Update update) throws IOException {
        Message msg = update.getMessage();


        Document docTeatrKurbasa = Jsoup.connect("http://www.zankovetska.com.ua/playbill/").get();
        Elements divElements = docTeatrKurbasa.getElementsByAttributeValue("class", "info");
        ...
        for (Element divElement : divElements.subList(0, 5)) {
            ...
            rowInline.add(new InlineKeyboardButton().setText("Детальніше").setUrl("http://www.zankovetska.com.ua" + urlTeatrKurbasa));
